...
export function ProcessingPage() {
  ...
  React.useEffect(() => {
    if (job?.status === "completed") {
      setLocation(`/jobs/${job.id}/preview`)
    }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-6">
        <div className="max-w-md w-full space-y-4">
          ...
          <button 
            onClick={() => setLocation("/")}
            className="text-sm font-medium underline hover:text-muted-foreground"
          >
            Start over
          </button>
        </div>
        ...
        <div className="pt-8 border-t border-border grid grid-cols-2 sm:grid-cols-4 gap-6">
          <div className="space-y-2">
            ...
            <p className="text-2xl font-bold">
              {job.extractedTextCount != null ? job.extractedTextCount : "—"}
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-2xl font-bold">
              {job.extractedImageCount != null ? job.extractedImageCount : "—"}
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-2xl font-bold">
              {job.slideCount != null ? job.slideCount : "—"}
            </p>
          </div>
        </div>
      </div>
